...
namespace Path
{
	...
	extern wxString CombineWx(const wxString& srcPath, const wxString& srcFile);
	extern wxString CombineWx(const wxDirName& srcPath, const wxFileName& srcFile);
	extern wxString CombineWx(const wxString& srcPath, const wxDirName& srcFile);
